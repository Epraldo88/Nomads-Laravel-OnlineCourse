            ...
            (this.adaptive = function () {
                ...
                (this.openzoom = function (o) {
                    switch (
                        ...
                        (L = !1),
                        (m = Ao("<div></div>")),
                        "" != V.options.sourceClass &&
                            m.addClass(V.options.sourceClass),
                        m.css("position", "absolute"),
                        (x = Ao("<div></div>")),
                        "" != V.options.loadingClass &&
                            x.addClass(V.options.loadingClass),
                        ...
                        V.options.title &&
                            ...
                            V.options.titleClass &&
                                j.addClass(V.options.titleClass),
                            j.html("<span>" + wo + "</span>"),
                            N.append(j),
                            V.options.fadeIn && N.css({ opacity: 0 })),
                        (k = Ao("<div></div>")),
                        "" != V.options.lensClass &&
                            k.addClass(V.options.lensClass),
                        ...
                        C.xon("load", function (o) {
                            ...
                            for (
                                ...
                                (t = parseFloat(k.css(e[i] + "top-width"))),
                                    (F += t != t ? 0 : t),
                                    (t = parseFloat(
                                        k.css(e[i] + "bottom-width")
                                    )),
                                    (F += t != t ? 0 : t),
                                    (t = parseFloat(
                                        k.css(e[i] + "left-width")
                                    )),
                                    (W += t != t ? 0 : t),
                                    (t = parseFloat(
                                        k.css(e[i] + "right-width")
                                    )),
                                    (W += t != t ? 0 : t);
                            (F /= 2),
                                (W /= 2),
                ...
                (this.init = function (o) {
                    (V.options = Ao.extend({}, Ao.fn.xzoom.defaults, o)),
                        ...
                        (U =
                            V.options.lensReverse &&
                            "inside" == V.options.position),
                        V.options.smoothZoomMove < 1 &&
                            (V.options.smoothZoomMove = 1),
                        V.options.smoothLensMove < 1 &&
                            (V.options.smoothLensMove = 1),
                        V.options.smoothScale < 1 &&
                            (V.options.smoothScale = 1),
                        V.options.adaptive &&
