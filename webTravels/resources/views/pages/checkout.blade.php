                ...
                <div class="row">
                    <div class="col-lg-8 pl-lg-0">
                        <div class="card card-details">
                            ...
                            <h1>Who's going?</h1>
                            <p>
                                Trip to {{ $item->travel_package->title }}, {{ $item->travel_package->title }}
                            </p>
                            <div class="attendee">
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle">
                                                    <a href="{{ route('checkout-remove', $detail->id) }}">
                                                        <img src="{{ url('frontend/assets/images/ic_remove.png') }}" height="18"/>
                                                    </a>
                                                </td>
                                            </tr>
                                        @empty
                            ...
                            <div class="member mt-3">
                                ...
                                <form class="form-inline" method="post" action="{{ route('checkout-create', $item->id) }}">
                                    ...
                                    <div class="input border rounded mb-2 mr-sm-2 ">
                                        <input type="text" class="form-control datepicker px-2"
                                ...
                                <p class="disclaimer mb-0">
                                    You are only able to invit emember that has registered in Nomads.
                                </p>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function(){
            $('.datepicker').datepicker({
                ...
                icons: {
                    rightIcon:'<img src="{{ url('frontend/assets/images/ic_calendar.png') }}" class="calendar-icon">'
                }
            });
        });
    </script>
